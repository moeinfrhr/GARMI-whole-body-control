...
class WholeBodyController : public controller_interface::MultiInterfaceController<
...
public:
    ...
    struct ArmContainer {
        ...
        Eigen::Vector3d spatialOffset_; // Define the spatial offset between the two arms
        bool arm_left;
        ...
        Eigen::Vector3d position_ee_;
        Eigen::Vector3d position_;
        Eigen::Vector3d position_d_;
        Eigen::Vector3d position_home_;
        Eigen::Vector3d position_d_temp_;
        Eigen::Quaterniond orientation_;
        Eigen::Quaterniond orientation_d_;
        Eigen::Quaterniond orientation_home_;
